...
void read_problem(char* filename) {
    ...
    while ((fin.getline(line, CHAR_LEN - 1))) {
        ...
        if (!strcmp(keywords, "DIMENSION")) {
            if (!sscanf_s(strtok(NULL, Delimiters), "%d", &problem_size)) {
            ...
            if (problem_size != 0) {
                ...
                cout << "\nWrong problem instance file" << endl;
                exit(1);
            }
        }
